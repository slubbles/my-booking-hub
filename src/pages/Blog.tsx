      ...
      <div className="py-24 md:py-32">
        <div className="container mx-auto px-6 max-w-2xl">
          <ScrollReveal>
            ...
            <p className="text-[15px] text-muted-foreground mb-10 font-light">Technical deep dives and lessons from shipping production apps.</p>
          </ScrollReveal>
                ...
                >
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      ...
                      <p className="text-[15px] text-muted-foreground leading-[1.7] mb-4">{post.excerpt}</p>
