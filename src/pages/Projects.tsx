      ...
      <div className="space-y-4">
        {projects.map((project, i) => (
          <ScrollReveal key={project.title} delay={i * 0.06}>
            <div className="group border border-border rounded-2xl p-6 hover:border-foreground/15 hover:shadow-sm transition-all cursor-pointer">
              <div className="flex items-start justify-between mb-3">
                ...
                <ExternalLink size={16} className="text-muted-foreground group-hover:text-foreground transition-colors mt-1 opacity-0 group-hover:opacity-100" />
              </div>
